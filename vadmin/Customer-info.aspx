<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Customer-info.aspx.cs" Inherits="vadmin_Customer_info" %>
...
<link href="http://ajax.aspnetcdn.com/ajax/jquery.ui/1.8.9/themes/blitzer/jquery-ui.css"
   ...
   <div id="dialog" style="display: none" align = "center">
    ...
    <form id="Form1" runat="server" style="background-color: #C0C0C0; " class="style10">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:TextBox ID="txtmobileno" 
                 ...
                 Text="Search" onclick="btnp_search1_Click" BackColor="#990000" 
                 ForeColor="White" />
                                                                             &nbsp;<asp:Label 
                                                     ...
                                                     <tr>
                                                         <td colspan="2">
                                                             &nbsp;&nbsp;&nbsp;&nbsp;<asp:ImageButton ID="imgbtn" runat="server" 
                                                                 ImageUrl="~/new_images/excel-logo.gif" onclick="imgbtn_Click" />
&nbsp;<asp:Panel ID="Panel4" runat="server" ScrollBars="Both" Height="353px">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
                 ...
                 BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" 
                                                              ...
                                                              <asp:Panel ID="pnlupdate" runat="server" BackColor="#666699"
                                                                                       
                                                                 BorderColor="#990000" BorderStyle="Solid" Height="295px" Visible="False"
                                                                                  
                                                                 Width="346px" CssClass="style3">
                                                                                 
                                                             <table class="style7">
                                                                     <tr>
                                                                         <td style="color: #FFFFFF; " class="style6">
                                                                             <asp:TextBox ID="txtc_name" runat="server" placeholder="NAME......." Height="29px" Width="138px" 
                                                                                 ForeColor="#000099"></asp:TextBox>
                                                                         </td>
                                                                         <td class="style4" colspan="2">
                                                                             <asp:TextBox ID="txtc_mob" runat="server" placeholder="MOBILE......." Height="29px" Width="138px" 
                                                                                 ForeColor="#000099"></asp:TextBox>
                                                                         </td>
                                                                     </tr> <tr><td></td></tr>
                                                                      <tr>
                                                                         <td style="color: #FFFFFF; " class="style6">
                                                                             <asp:TextBox ID="txtc_pwd" runat="server" placeholder="PASSWORD......." 
                                                                                 Height="29px" Width="138px" 
                                                                                 ForeColor="#000099" Enabled="False"></asp:TextBox>
                                                                         </td>
                                                                         <td class="style4" colspan="2">
                                                                             <asp:TextBox ID="txtc_newpwd" runat="server" placeholder="New Password......." 
                                                                                 Height="29px" Width="138px" MaxLength="10" TextMode="Password" 
                                                                                 ForeColor="#000099"></asp:TextBox>
                                                                             &nbsp;&nbsp;
                                                                         </td>
                                                                      ...
                                                                      <tr>
                                                                         <td style="color: #FFFFFF; " class="style6">
                                                                             <asp:TextBox ID="txtc_cnfrmpwd" runat="server" 
                                                                         ...
                                                                         <td class="style4">
                                                                          ...
                                                                          <caption class="style9">
                                                                              ...
                                                                              <asp:Button ID="btnclose2" runat="server" BackColor="#990000" CssClass="style8" 
                                                                                  ForeColor="White" onclick="btnclose2_Click" Text="X" />
                                                                              </span>&nbsp;<br />
                                                                              </caption>
                                                                     </tr>
                                                                     <tr>
                                                                     ...
                                                                     <tr>
                                                                         <td colspan="2" style="text-align: center">
                                                                             <asp:Button ID="btnupdate" runat="server" class="btn theme-btn-color" 
                                                                                  Text="Update" onclick="btnupdate_Click" BackColor="#990000" Height="35px" 
                                                                                 Width="86px" ForeColor="White" />
                                                                         </td>
