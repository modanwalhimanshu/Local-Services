<%@ Page Language="C#" AutoEventWireup="true" CodeFile="employee-signup.aspx.cs" Inherits="employee_signup" %>
        ...
        <div class="container">
            ...
            <center>
                <div class="employee_register">
                    <br />
                    <div class="employee_register_form">
                        <br />
                        <h1>Create Account</h1>
                        <h4>Your name(Full Name)* </h4>
                        <asp:TextBox ID="employee_name" runat="server" placeholder="Your Name" CssClass="name_employee"></asp:TextBox>
                        <br />
                        <asp:Label ID="lblemployeename" runat="server" ForeColor="Red"></asp:Label>
                        <br />
                        <h4>Designation*</h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:DropDownList ID="employee_designation" runat="server"  CssClass="designation_employee">
                        ...
                        <br />
                        <h4>Address*</h4>
                        <asp:TextBox ID="employee_address" runat="server" placeholder="Address" CssClass="mobile_employee" TextMode="MultiLine"></asp:TextBox>
                        <br />
                        <asp:Label ID="lbladdress" runat="server" ForeColor="Red"></asp:Label>
                        <br />
                        <h4>Pincode*</h4>
                        <asp:TextBox ID="pincode" runat="server" placeholder="Pincode" CssClass="mobile_employee"></asp:TextBox>
                        <br />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="pincode" ErrorMessage="Invaid Pincode" ForeColor="Red" ValidationExpression="\d{6}"></asp:RegularExpressionValidator>
                        <asp:Label ID="lblpincode" runat="server" ForeColor="Red"></asp:Label>
                        <br />
                        <h4>Contact Number</h4>
                        <asp:TextBox ID="employee_contectno" runat="server" placeholder="Contact No." CssClass="mobile_employee"></asp:TextBox>
                        <br /><br />
                        <h4>Mobile number*</h4>
                        <asp:TextBox ID="employee_mobileno" runat="server" placeholder="Mobile No." CssClass="mobile_employee"></asp:TextBox>
                        <br />
                        <asp:Label ID="lblmobileno" runat="server" ForeColor="Red"></asp:Label>
                        <br />
                        <h4>Remark</h4>
                        <asp:TextBox ID="remark" runat="server" placeholder="Remark" CssClass="mobile_employee" TextMode="MultiLine"></asp:TextBox>
                        <br /><br />
                        <h4>Email address*</h4>
                        ...
                        <br />
                        <h4>Password*</h4>
                        <asp:TextBox ID="employee_password" runat="server" placeholder="at least 6 character" CssClass="password_employee" TextMode="Password"></asp:TextBox>
                        <br />
                        <asp:Label ID="lbl_password" runat="server" ForeColor="Red"></asp:Label>
                        <br />
                        <h4>Confirm password*</h4>
                        <asp:TextBox ID="confirm_employee_password" runat="server" placeholder="Confirm Password" CssClass="confirm_password_employee" TextMode="Password"></asp:TextBox>
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="employee_password" ControlToValidate="confirm_employee_password" ErrorMessage="Password does'nt match" ForeColor="Red"></asp:CompareValidator>
                        <asp:Label ID="lbl_cnf_pwd" runat="server" ForeColor="Red"></asp:Label>
                        <br /><br />
                        
                        <asp:CheckBox ID="Chkterms" runat="server" CssClass="chkterms_employee" Text="I accept all terms and Condition" OnCheckedChanged="Chkterms_CheckedChanged"></asp:CheckBox>
                        &nbsp;&nbsp;
                        <br /><br />
                        <asp:Button ID="employee_sign_up" runat="server" Text="Sign Up" CssClass="signup_employee" OnClick="employee_sign_up_Click"></asp:Button>
                        <br /><br />
                        ...
                        &nbsp;&nbsp;
                        <asp:LinkButton ID="lbn_signin" runat="server" CssClass="signin_employee" OnClick="lbn_signin_Click">Signin</asp:LinkButton>
