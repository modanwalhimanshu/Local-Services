<%@ Page Language="C#" AutoEventWireup="true" CodeFile="c-edit-profile.aspx.cs" Inherits="c_edit_profile" %>
                ...
                <div class="container">
                    ...
                    <div class="pull-right">
                        <ul class="info list-inline hidden-xs">
                            <li><a href="customer-signup.aspx" class="hover-color">Create an account?</a></li>
                            <li><a href="customer-login.aspx" class="hover-color"><i class="ion-man"></i> Login</a></li>
                        </ul>
                    </div>
                </div><!--container end-->
            </div><!--topbar end-->
            ...
            <center>
                <div class="customer_edit">
                    ...
                    <div class="customer_edit_form">
                        ...
                        <asp:TextBox ID="c_txtname" runat="server" placeholder="Your Name" CssClass="name_employee" MaxLength="50"></asp:TextBox>
                        <br />
                        <asp:Label ID="lblemployee_name" runat="server" ForeColor="Red"></asp:Label>
                        <br />
                        <h4>Mobile number</h4>
                        <asp:TextBox ID="c_txtmobileno" runat="server" placeholder="Mobile No." CssClass="mobile_employee" MaxLength="10"></asp:TextBox>
                        <br />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid Mobile No" ControlToValidate="c_txtmobileno" ForeColor="Red" ValidationExpression="^([7-9]{1})([0-9]{9})$"></asp:RegularExpressionValidator>
                        <asp:Label ID="lblemployee_mobileno" runat="server" ForeColor="Red"></asp:Label>
                        <br />
                        <h4>Email address</h4>
                        <asp:TextBox ID="c_txtemail" runat="server" placeholder="Enter Email Address" CssClass="email_employee" MaxLength="50" Enabled="False"></asp:TextBox>
                        <br />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Invalid Email Id" ControlToValidate="c_txtemail" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                       <asp:Label ID="lblemployee_email" runat="server" ForeColor="Red"></asp:Label>
                        <br />
                        
                       
                        <asp:Button ID="btn_update" runat="server" Text="Update"  CssClass="signup_employee" OnClick="btn_update_Click"   ></asp:Button>
