<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p-reset-pwd.aspx.cs" Inherits="p_forgotpwd" %>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="my-login-form">
                            ...
                            <h4 class="heading-mini">Reset Password</h4>
                       ...
                       <p>  <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                                 ...
                                 <p>  
                                     <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                         ControlToCompare="P_txtpswd2" ControlToValidate="P_txtpswd3" 
                                         ErrorMessage="Password is not matched" ForeColor="#CC0000"></asp:CompareValidator>
                                 </p>
