<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P_Uploadphoto.aspx.cs" Inherits="P_Uploadphoto" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <form id="Form1" runat="server" >
        ...
        <div class="container">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="my-login-form">
                        <h3 class="heading-mini"> <asp:Label   ID="lblmsg2" runat="server" Font-Size="Large" ForeColor="#CC3300"></asp:Label></h3>
                            ...
                            <div class="form-group">
                            <h4>Profile Pic*</h4>
                                <asp:FileUpload ID="photouplod" class="form-control" runat="server" /> 
                            </div>
                             <div class="form-group">
            ...
            <asp:Button ID="pbtnupldphoto" runat="server" class="btn theme-btn-color" Text="Upload Photo" onclick="Button2_Click" 
                                    />
