<%@ Page Language="C#" AutoEventWireup="true" CodeFile="professional_login.aspx.cs" Inherits="professional_login" %>
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                <a href="Become_Professional.aspx">Sign up</a>
     ...
     <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="my-login-form">
                            ...
                            <h4 class="heading-mini">Login</h4>
           ...
           <p>  <asp:RegularExpressionValidator ID="RegularExpressionValidator" runat="server" 
                            ...
                            <div class="form-group">
                             <asp:TextBox ID="P_txtpswd" runat="server"  class="form-control"
            ...
            <asp:Button ID="pbtnlogin" runat="server" class="btn theme-btn-color" Text="Login" 
                    ...
                    <h4>
                     ...
                     <h4> Create new account?
                      <asp:LinkButton ID="lnkbtnsignup" 
                          runat="server" PostBackUrl="~/Become_Professional.aspx">Sign up</asp:LinkButton> </h4>
                        </div> 
